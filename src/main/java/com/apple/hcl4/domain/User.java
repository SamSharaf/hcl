...
import static com.apple.hcl4.config.Constants.LOGIN_REGEX;
import static com.apple.hcl4.config.Constants.EMAIL_REGEX;
import static com.apple.hcl4.config.Constants.EMAIL_REGEX_MESSAGE;
...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    private static final long serialVersionUID = -154847285496114960L;
...
//        return MessageFormat.format("User{id={0}, login={1}, firstName={2}, lastName={3}, email={4}, activated={5}, activationKey={6}}", id, login, firstName, lastName, email, activated, activationKey);
//    }
